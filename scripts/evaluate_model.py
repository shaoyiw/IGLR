...
from isegm.inference.evaluation import evaluate_dataset, evaluate_dataset_certain_click


def parse_args():
    parser = argparse.ArgumentParser()

    parser.add_argument('--mode', choices=['CDNet', 'Baseline', 'ISLR', 'NoBRS', 'RGB-BRS', 'DistMap-BRS',
                                           'f-BRS-A', 'f-BRS-B', 'f-BRS-C'], required=False, default='ISLR',
                        help='')

    group_checkpoints = parser.add_mutually_exclusive_group(required=False)
    group_checkpoints.add_argument('--checkpoint', type=str, required=False,
                                   default='/home/ubuntu/liu/ISLR/experiments/ISLRformer/segformerB3_S2_cclvs/000_segformerB3_S2_cclvs_num_4/checkpoints/083.pth',
                                   help='The path to the checkpoint. '
                                        'This can be a relative path (relative to cfg.INTERACTIVE_MODELS_PATH) '
                                        'or an absolute path. The file extension can be omitted.')

    parser.add_argument('--model_dir', required=False, type=str,
                        default='', help='The path to the checkpoint.')

    group_checkpoints.add_argument('--exp-path', type=str, required=False, default='',
    ...
    parser.add_argument('--datasets', type=str,  # default='GrabCut,Berkeley,DAVIS,SBD,PascalVOC',
                        ...
                        help='List of datasets on which the model should be tested. '
                             ...
                             'GrabCut,Berkeley,DAVIS,SBD,PascalVOC,COCO_MVal')

    group_device = parser.add_mutually_exclusive_group()
    group_device.add_argument('--gpus', type=str, default='1',
                              help='ID of used GPU.')
    ...
    group_checkpoints.add_argument('--vis_path', type=str, required=False, default='',
                                   help='saveing path for the evaluation results')
    parser.add_argument('--model-name', type=str, default=None,
                        help='The model name that is used for making plots.')
    parser.add_argument('--config-path', type=str, default='../config.yml',
                        help='The path to the config file.')
    parser.add_argument('--logs-path', type=str, default='/home/ubuntu/liu/ISLR/experiments/ISLRformer/segformerB3_S2_cclvs/000_segformerB3_S2_cclvs_num_4/evaluation_logs/',
                        help='The path to the evaluation logs. Default path: cfg.EXPS_PATH/evaluation_logs.')
    parser.add_argument('--save-path', type=str,
                        default='/home/ubuntu/liu/ISLR/experiments/ISLRformer/segformerB3_S2_cclvs/000_segformerB3_S2_cclvs_num_4/evaluation_logs/',
    ...
    parser.add_argument('--with-flip', action='store_true', default=True)
