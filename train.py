...
def parse_args():
    ...
    parser.add_argument('--model_path', type=str, default='models/ISLRformer/segformerB3_S2_cclvs.py', required=False,
                        help='Path to the model script.')

    parser.add_argument('--exp-name', type=str, default='segformerB3_S2_cclvs_num_4',
